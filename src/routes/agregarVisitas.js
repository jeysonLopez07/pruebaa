...
router.post("/agregarVisitas",(req)=>{
    const {codigoS,nombre1,identidad1,nombre2,identidad2,nombre3,identidad3,nombre4,identidad4,nombre5,identidad5,nombre6,identidad6}=req.body
    ...
    const values5=[codigoS,nombre5,identidad5]
    const values6=[codigoS,nombre6,identidad6]
    ...
    if(nombre5!="" || identidad5!="" ){
        mysqlConecction.query("INSERT INTO visitas_Data(id_Solicitud,Nombre,id) values(?,?,?)",values5,(err,rows,fields)=>{
        }); 
    }


    if(nombre6!="" || identidad6!="" ){
        mysqlConecction.query("INSERT INTO visitas_Data(id_Solicitud,Nombre,id) values(?,?,?)",values6,(err,rows,fields)=>{
        }); 
    }
